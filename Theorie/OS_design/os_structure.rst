...
Le programme `ld(1)`_ jour ce rôle sous GNU/Linux.
...
- Enfin, l'appel `execve(2)`_ est utilisé pour envoyer vers :term:`STDOUT` la chaîne de caractères formatée par la fonction correspondante de la librairie standard, `printf(3)`_.
